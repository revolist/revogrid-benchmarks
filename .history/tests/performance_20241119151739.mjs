import { timeout } from "@revolist/vue3-datagrid";
...
(async () => {
  ...
  await testPage(page, "ag", ".ag-body-viewport", '.ag-cell-value[col-id="0"]');
  await testPage(page, "rv", "revo-grid revogr-viewport-scroll.rgCol .vertical-inner", '.rgCell[data-rgcol="0"]');
  await testPage(page, "ht", ".ht_master.handsontable > .wtHolder", '.ht_master.handsontable > .wtHolder td[role="gridcell"][aria-colindex="1"]');
  await browser.close();
})();
